...
class MessageLoggerRequestId extends \App\Shared\Domain\ValueObject\ValueObject
{
    private function __construct(private mixed $requestId)
    {
    }

    public static function create(mixed $requestId): self
    {
