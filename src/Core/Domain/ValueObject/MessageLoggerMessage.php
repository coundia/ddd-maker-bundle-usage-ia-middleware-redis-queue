...
class MessageLoggerMessage extends \App\Shared\Domain\ValueObject\ValueObject
{
    private function __construct(private mixed $message)
    {
    }

    public static function create(mixed $message): self
    {
