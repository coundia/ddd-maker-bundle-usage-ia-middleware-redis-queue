...
use App\Core\Application\Query\FindMessageLoggerPaginatedQuery;
use App\Entity\MessageLogger;
use Doctrine\ORM\EntityManagerInterface;
use Symfony\Component\Messenger\Attribute\AsMessageHandler;

#[AsMessageHandler]
class FindMessageLoggerPaginatedQueryHandler
{
    ...
    public function __invoke(FindMessageLoggerPaginatedQuery $query): array
    {
        $page = $query->page;
        $limit = $query->limit;
        $offset = ($page - 1) * $limit;
